/**
 * ============================================================================
 * RODAPÉ — CRÉDITOS + CONTATO
 * ============================================================================
 * Aparece centralizado no fim de toda página (App.tsx e LoginPage.tsx).
 */
...
export function Rodape() {
  ...
  return (
    <footer className="app-rodape">
      <p>
        Copyright © {ano} | <strong>Zaqueu Fernandes</strong> | Suporte Técnico
      </p>
      <a
        className="app-rodape-whatsapp"
        href={`https://wa.me/${NUMERO_WHATSAPP}`}
        target="_blank"
        rel="noopener noreferrer"
      >
        <IconeWhatsApp /> WhatsApp: {NUMERO_EXIBICAO}
      </a>
    </footer>
  );
}
