...
// buscarPecasEstoqueBaixo/PecaEstoqueBaixo mudaram pra @/features/estoque
// (pertence conceitualmente lá — só lê `pecas`, nada de financeiro/empresa).
// Reexportado por dashboard/index.ts pra não quebrar quem já importava daqui.
